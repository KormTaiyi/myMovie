...
const FootCom = () => {
  return (
    <footer className="bg-(--primary-color) py-8">
      <div className="w-full md:w-[90%] max-w-7xl m-auto md:flex items-start md:justify-between">
        <img src={logo} alt="" className="w-20 md:mb-0 mb-4 object-contain md:m-0 m-auto"/>
        <div className="flex text-white px-6 gap-10 items-center justify-between flex-col sm:flex-row sm:text-left text-center">
          <ul type="none">
